...
class MLPlay:
    ...
    def update(self, scene_info):
        ...
        #         # PlatformX_1P = scene_info["platform_2P"][0] + 20
        #         # PlatformY_1P = scene_info["platform_2P"][1] + 20
        ...
        #         # CSV_Read_1P.doWrite(BallCoordinate_Now[0], BallCoordinate_Now[1], m, ball_speed[0], ball_speed[1], PlatformX, PlatformY, PlatformX_1P, PlatformY_1P, BallUpAndDown_NUM) ml
        #         # # ball_speed[1] > 0 down    ball_speed[1] < 0 up
        #         if ball_speed[1] > 0 and BallCoordinate_Now[1] >=415-abs(ball_speed[0]):
        #             if ball_speed[0]>0:
        #                 return "MOVE_RIGHT"
        #             else:
        #                 return "MOVE_LEFT"
